...
echo -e "${BLUE}🚀 Aceternity Automation Package Installer${NC}"
echo ""
...
if [ ! -d "$TARGET_DIR" ]; then
    echo -e "${YELLOW}❌ Directory not found: $TARGET_DIR${NC}"
    exit 1
fi
...
# Step 1: Copy scripts
echo -e "${BLUE}📝 Step 1: Copying automation scripts...${NC}"
...
echo -e "${BLUE}📚 Step 2: Copying documentation...${NC}"
...
echo -e "${BLUE}📄 Step 4: Creating README files...${NC}"
...
echo ""
echo -e "${GREEN}🎉 Ready to use! Check ACETERNITY-QUICKSTART-AUTOMATION.md for usage examples.${NC}"
